...
public:
    ...
    QString left(int index) const;
    QString right(int index) const;
    ...
    QString leftJustified(int width, char fill = ' ', bool trunc = false ) const;
    QString rightJustified(int width, char fill = ' ', bool trunc = false ) const;
